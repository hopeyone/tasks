...
import TodoUpdateComponent from '@/entities/todo/todo/todo-update.vue';
import TodoClass from '@/entities/todo/todo/todo-update.component';
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TodoClass>(TodoUpdateComponent, {
        ...
        provide: {
          ...
          todoGroupService: () =>
            sinon.createStubInstance<TodoGroupService>(TodoGroupService, {
