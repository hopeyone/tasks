...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mrhopeyone.tasks.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mrhopeyone.tasks.security.DomainUserDetailsService", "createSpringSecurityUser");
