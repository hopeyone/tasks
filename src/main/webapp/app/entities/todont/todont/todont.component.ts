...
export default class Todont extends mixins(JhiDataUtils) {
  ...
  public retrieveAllTodonts(): void {
  ...
  public prepareRemove(instance: ITodont): void {
  ...
  public removeTodont(): void {
    this.todontService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('todontApp.todontTodont.deleted', { param: this.removeId });
